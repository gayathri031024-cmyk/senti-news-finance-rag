...
The application uses a configurable LLM provider for grounded answer generation. **Groq is used for the live generation path.**
...
The API key is provided through an environment variable and should never be committed to the repository.
